            ...
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <div className="mt-12 flex flex-col sm:flex-col items-center sm:items-start gap-5">
                ...
                <div className="flex flex-col justify-between items-center sm:items-start">
                  ...
                  <p>
                    <span className="font-semibold">2650</span> happy customers
                  </p>
                </div>
              </div>
            </div>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            ...
            <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5"/>
              Scratch and finger-print resisitant coating
            </li>
            <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5"/>
            ...
            <div className="flex justify-center">
              ...
              })} href = '/configure/upload'>Create your case now<ArrowRight className="h-4 w-4 ml-1"/></Link>
            </div>
          </ul>
        </MaxWidthWrapper>
      </section>
